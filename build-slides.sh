...
# build deckset
mdslides compile config.yaml src/ tmp/ --chapter-title=img --glossary=glossary.yaml --section-prefix=" Pattern %(chapter)s.%(section)s:"
...
# build reveal.js
mdslides compile config.yaml src/ tmp/ --chapter-title=text --glossary=glossary.yaml --section-prefix=" Pattern %(chapter)s.%(section)s:"
...
mdslides compile config.yaml src/ tmp/ --chapter-title=none --glossary=glossary.yaml --section-prefix=" Pattern %(chapter)s.%(section)s:"
